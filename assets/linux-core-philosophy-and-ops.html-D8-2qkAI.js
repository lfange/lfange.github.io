import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as s,o as a,b as e}from"./app-ByTKU10L.js";const l={},t=e(`<h1 id="linux-核心思想与常用操作实战" tabindex="-1"><a class="header-anchor" href="#linux-核心思想与常用操作实战"><span>Linux 核心思想与常用操作实战</span></a></h1><h2 id="一、linux-核心思想-——-理解它-才能驾驭它" tabindex="-1"><a class="header-anchor" href="#一、linux-核心思想-——-理解它-才能驾驭它"><span>一、Linux 核心思想 —— 理解它，才能驾驭它</span></a></h2><h3 id="_1-1-一切皆文件-everything-is-a-file" tabindex="-1"><a class="header-anchor" href="#_1-1-一切皆文件-everything-is-a-file"><span>1.1 一切皆文件 (Everything is a File)</span></a></h3><p>这是 Linux 最根本的设计哲学。在 Linux 中，<strong>普通文件、目录、设备、进程、网络 socket，甚至内核参数，都以文件的形式呈现</strong>。</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>普通文件    →  ~/documents/note.txt      （读写数据）
