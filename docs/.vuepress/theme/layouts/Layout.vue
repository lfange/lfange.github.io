<script setup lang="ts">
  ...
  const heroAlt = computed(() => frontmatter.value.heroAlt || heroText.value || 'Best for the Best!')
...
<template>
  <div class="home-main" v-if="frontmatter.layout">
    <div class="full-screen">
      ...
      <button class="slide-down-button" @click="tobuttom"
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          class="icon slide-down-icon"
