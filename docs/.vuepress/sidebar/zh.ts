...
export const zhSidebarConfig = sidebar({
  ...
  '/computer/': [
    ...
    },
    {
      ...
      icon: 'network',
      children: [
        comBase('net/01-http-https'),
        comBase('net/02-tcp-advanced'),
        comBase('net/03-dns-cdn'),
        comBase('net/04-realtime-communication'),
        comBase('net/05-network-programming'),
        comBase('net/06-troubleshooting'),
        comBase('net/07-network-interview'),
      ],
    },
