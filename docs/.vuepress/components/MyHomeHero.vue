...
const BackGroundDiv: FunctionalComponent = () => {
  ...
  console.log('withBase(heroImage.value)', heroImage, withBase(heroImage.value), heroHeight)
  const div = h('div', {
    style: {
      background: `url(${withBase(heroImage.value)}) center center / cover no-repeat`,
    },
    class: 'mask',
